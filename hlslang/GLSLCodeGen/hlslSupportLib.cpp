...
void insertPost120TextureLookups()
{
	...
	hlslSupportLib->insert(CodeMap::value_type(EOpTex2DArrayGrad, "vec4 xll_tex2DArrayGrad(sampler2DArray s, vec3 coord, vec2 ddx, vec2 ddy) { return textureGrad (s, coord, ddx, ddy); }\n"));
